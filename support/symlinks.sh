...
local_dotfile_symlinks=([zshrc]=$HOME/.zshrc [vimrc]=$HOME/.vimrc [gitignore]=$HOME/.gitignore [lambo]=$HOME/.lambo [aws]=$HOME/.aws [gitconfig]=$HOME/.gitconfig [gmvault]=$HOME/.gmvault [gnupg]=$HOME/.gnupg [zsh_history]=$HOME/.zsh_history)
...
#        (600 for both)
#remote_dotfile_symlinks=([ssh]=$HOME/.ssh)
